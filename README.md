...
## 🎯 Objetivo
<p align="justify"> As aulas práticas tem como objetivo ensinar os alunos a realizarem o download, processamento e plotagens de dados provenientes de satélites meteorológicos com a linguagem Python através do Google Colab. </p>
